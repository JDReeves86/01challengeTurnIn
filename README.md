...
THEN I find semantic HTML elements ** COMPLETED 7.5.2022**
WHEN I view the structure of the HTML elements
THEN I find that the elements follow a logical structure independent of styling and positioning ** COMPLETED? 7.5.2022 **
WHEN I view the icon and image elements
THEN I find accessible alt attributes ** COMPLETED 7.5.2022 - DESCRIPTIONS COULD BE MORE PROFESSIONAL **
WHEN I view the heading attributes
THEN they fall in sequential order ** COMPLETED 7.5.2022 **
WHEN I view the title element
THEN I find a concise, descriptive title ** COMPLETED 7.5.2022 ** 
```
